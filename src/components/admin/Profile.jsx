...
export default function Profile() {
  ...
  return (
    <div
      className="relative"
      tabIndex={0}
      onBlur={() => setProfileVisibility(false)}
    >
      <ProfileAvatar
      ...
      >
        <div className="flex items-center px-3 py-2 space-x-2">
          ...
          <div className="w-48 max-w-56 flex flex-col items-start">
            <span className="text-md text-start text-slate-800 text-nowrap font-semibold">
              {adminUsername}
            </span>
        ...
        <div className="w-full flex flex-col items-start p-2 font-semibold">
          <button className="w-full flex items-center gap-1 text-sm text-slate-600 text-left px-2 py-1 hover:bg-slate-100 rounded-md transition-colors">
        ...
        <div className="w-full p-2 font-semibold">
          <button className="w-full flex items-center gap-2 text-sm text-rose-600 text-left px-2 py-1 rounded-md transition-colors group hover:bg-rose-100 hover:text-rose-700">
